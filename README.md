...
You can run a local web app to manage your sample library and build custom firmware without touching the command line. See [docs/sample_studio.md](docs/sample_studio.md) for full details.
